...
def temp_and_pm_data(location):
    key=os.getenv('pm_key')
    url = f'http://openapi.airkorea.or.kr/openapi/services/rest/ArpltnInforInqireSvc/getCtprvnMesureSidoLIst?sidoName=%EC%84%9C%EC%9A%B8&searchCondition=DAILY&pageNo=2&numOfRows=20&ServiceKey={key}'
